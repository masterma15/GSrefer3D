...
if __name__ == '__main__':
    ...
    depth_anything.load_state_dict(torch.load(f'/home/zhouenshen/ckpt/depthanything/depth_anything_v2_{args.encoder}.pth', map_location='cpu'))
    ...
    for filename in tqdm(filenames, desc="Processing images", unit="image"):
        ...
        depth = depth_anything.infer_image(raw_image, args.input_size, device=DEVICE)
